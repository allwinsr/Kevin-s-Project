...
<div class="wrapper" style="height:755px;">
	     ...
	     <div class="content">
               ...
               <div id="login" class="login">
						...
						<input type="submit" name="btn" value="Submit" id="button"/><br/>
						<?php
							if(isset($_POST['btn'])=="Submit")
							{
									...
									$username=$_POST['usr'];
									$password=$_POST['pwd'];
									$sql="select *from login where u_name='$username' and u_password='$password'";
					    ...
					    <a href="index1.php" class="usertype">Admin login</a><br>
